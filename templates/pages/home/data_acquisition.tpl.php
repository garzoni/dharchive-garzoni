...
<div class="row">
    <div class="sixteen wide column">
        <div class="ui padded text container segment">
            ...
            <p>The annotation part of the interface is not accessible to the public, you can however discover the annotation workflow through this video:</p>
            ...
            <iframe id="kmsembed-0_eh6i9npv" width="400" height="285" src="https://mediaspace.epfl.ch/embed/secure/iframe/entryId/0_eh6i9npv/uiConfId/23448972/pbc/49179/st/0" class="kmsembed" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" referrerPolicy="no-referrer-when-downgrade" sandbox="allow-downloads allow-forms allow-same-origin allow-scripts allow-top-navigation allow-pointer-lock allow-popups allow-modals allow-orientation-lock allow-popups-to-escape-sandbox allow-presentation allow-top-navigation-by-user-activation" frameborder="0" title="Garzoni Project - Data Acquisition Illustration"></iframe>
        </div>
    </div>
</div>
