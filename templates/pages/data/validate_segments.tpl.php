...
<script>
    $(document).ready(function() {
        ...
        var dtTable = $('#segment-errors-table'),
            dtFilter = $('#segment-errors-table-filter'),
        ...
        var dtContractErrors = dtTable.DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo $this->app->getUrl('controller', 'get-segment-errors'); ?>',
                type: 'POST',
                data: function (data) {
                    var errorTypes = [];
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a href="<?php echo $this->app->getUrl('module', 'page/view'); ?>/'
                            + row.document_id + '/' + row.canvas_code + '?highlight='
                            + data + '">' + row.segment_bbox + '</a>';
                    }
                },
                {
                    data: 'error_type'
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<i class="' + classNames + '" data-entity-id="'
                            + row.segment_id + '" data-error-type-id="'
                            + row.error_type_id + '"></i>';
                    }
                },
                {
...
<div class="row">
    <div class="twelve wide column">
        <div class="ui segment box">
            <div class="header">
                <h4 class="title">Segment Errors</h4>
            </div>
            <div class="content">
                <table id="segment-errors-table" class="ui compact celled table" width="100%">
                    <thead>
                    <tr>
                        <th>Document</th>
                        <th>Page</th>
    ...
    <div class="four wide column">
        <div class="ui segment box">
            ...
            <div class="content">
                <form id="segment-errors-table-filter" class="ui form">
                    <div class="field">
