...
namespace Application\Core\Filter\Validation;
 ...
 * @package Application\Core\Filter\Validation
 */
class StringValidator extends Validator
{
    ...
    {
        return _($text)->getLength() === $length;
    }
    ...
    {
        return _($text)->getByteLength() === $length;
    }
    ...
    protected function contains(
        ...
        return _($text)->contains($needle, $caseSensitive);
    }
    ...
    protected function startsWith(
        ...
        return _($text)->startsWith($prefix, $caseSensitive);
    }
    ...
    protected function endsWith(
        ...
        return _($text)->endsWith($suffix, $caseSensitive);
    }
