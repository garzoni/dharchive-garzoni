...
use const Application\NAMESPACE_SEPARATOR;
...
class Autoloader
{
    ...
    public function addNamespace(
        ...
        $prefix = trim($prefix, NAMESPACE_SEPARATOR) . NAMESPACE_SEPARATOR;
    ...
    public function loadClass(string $class)
    {
        ...
        while (false !== $pos = strrpos($prefix, NAMESPACE_SEPARATOR)) {
            ...
            // of strrpos()
            $prefix = rtrim($prefix, NAMESPACE_SEPARATOR);
        }
    ...
    protected function loadMappedFile(string $prefix, string $relativeClass)
    {
        ...
        foreach ($this->prefixes[$prefix] as $baseDir) {
            ...
            $file = $baseDir . str_replace(NAMESPACE_SEPARATOR,
